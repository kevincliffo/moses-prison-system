    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
                <!-- Sidebar - Brand -->
                <?php 
                    echo anchor('main/dashboard', '<div class="sidebar-brand-icon rotate-n-15"><img src="img/favicon.png" alt="" srcset=""></div><div class="sidebar-brand-text mx-3">Prison Registration <sup>System</sup></div>', 'class="sidebar-brand d-flex align-items-center justify-content-center"');
                ?>
                <!-- Divider -->
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <?php echo anchor('main/adduser', 'Add User', 'class="collapse-item"');?>
                            <?php echo anchor('main/allusers', 'View Users', 'class="collapse-item"');?>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseReports" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Prisons:</h6>
                            <?php echo anchor('reports/users', 'Users', 'class="collapse-item"');?>
                            <?php echo anchor('reports/prisons', 'Prisons', 'class="collapse-item"');?>
                            <?php echo anchor('reports/prisoners', 'Prisoners', 'class="collapse-item"');?>
                            <?php echo anchor('reports/prisonersfilters', 'Prisoners with Filters', 'class="collapse-item"');?>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div id="collapseSettings" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <?php echo anchor('prisons/addcrime', 'Crimes', 'class="collapse-item"');?>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                    <?php 
                                        ...
                                        echo anchor('main/profile', '<i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i><span> Profile</span>', $obj);
                                    ?>
